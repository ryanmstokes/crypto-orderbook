...
jest.mock('store/features/tables', () => ({
  ...
  UseOrderbooks: () => ({ id: 'btc_eth', current: 'XBTC' }),
  UseWSConfig: () => ({ url: 'wss://www.cryptofacilities.com/ws/v1', feed: 'book_ui_1', symbol: 'PI_XBTUSD' }),
  UseTableHeaders: () => ['Price', 'amount', 'Total'],
  SetInc: () => ({ type: 'SetInc' }),
  SetTickerSize: () => ({ type: 'SetTickerSize' }),
}))
